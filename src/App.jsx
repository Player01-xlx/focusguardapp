...
const DEFAULT_CUSTOMIZATION = {
  ...
  sectionOrder: ['aiInsights', 'smartRecommendations', 'distractionBlocker', 'moodEnergyTracker', 'localAnalytics', 'tasks', 'dailyGoals', 'focusAnalytics', 'achievements', 'streaks', 'sessionHighlights', 'smartReminders', 'deviceSync', 'settings', 'history', 'supportCreator'],
  headerButtons: {
    customize: true,
    analytics: true,
    notifications: true,
...
// Sort achievements by difficulty/rewards (coins) - easier achievements first
const ACHIEVEMENTS = [
...
export default function App() {
  ...
  useEffect(() => {
    localStorage.setItem("fg_distractionBlocker", JSON.stringify(distractionBlocker));
  }, [distractionBlocker]);

  useEffect(() => {
    localStorage.setItem("fg_moodEnergyTracker", JSON.stringify(moodEnergyTracker));
  }, [moodEnergyTracker]);
            ...
            <div style={{ display: "grid", gap: 8 }}>
              ...
              <div style={{ borderTop: '1px solid #e0e0e0', paddingTop: 12, marginTop: 8 }}>
                ...
                <div style={{ marginTop: 12 }}>
                  <div style={{ fontSize: 12, fontWeight: 600, marginBottom: 6 }}>👤 Username</div>
                  <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                    <span style={{ fontSize: 13, color: '#666' }}>{username || 'Not set'}</span>
                    <button 
                      style={{...currentStyles.smallBtn, fontSize: 10, padding: '4px 8px'}}
              ...
              <div style={{ 
                ...
                >
                  ...
                  <div style={{ fontSize: 12, opacity: 0.8 }}>
                    Two-column design with timer on left, sections on right
                  </div>
                </button>
