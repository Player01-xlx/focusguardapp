...
const DEFAULT_CUSTOMIZATION = {
  ...
  visibleSections: {
    ...
    supportCreator: true, // Now visible by default
    deviceSync: false,
    distractionBlocker: true, // New feature visible by default
    moodEnergyTracker: true, // New feature visible by default
    mindfulBreakCoach: true // New feature visible by default
  },
  sectionOrder: ['aiInsights', 'smartRecommendations', 'distractionBlocker', 'moodEnergyTracker', 'mindfulBreakCoach', 'localAnalytics', 'tasks', 'dailyGoals', 'focusAnalytics', 'achievements', 'streaks', 'sessionHighlights', 'smartReminders', 'deviceSync', 'settings', 'history', 'supportCreator'],
  headerButtons: {
    customize: true,
    analytics: true,
    notifications: true,
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const handleVisibilityChange = () => {
      if (document.hidden && running && mode === 'focus' && distractionBlocker.activeSessionOnly) {
  ...
  }, [distractionBlocker.enabled, distractionBlocker.activeSessionOnly, running, mode, distractionBlocker.isActive]);
  ...
  function handleTimerEnd() {
    // Deactivate distraction blocker
    if (distractionBlocker.isActive) {
      setDistractionBlocker(prev => ({ ...prev, isActive: false }));
    }
  ...
  function renderSection(sectionKey) {
    ...
    switch (sectionKey) {
        ...
        return (
          <div key="distractionBlocker" style={currentStyles.card}>
            ...
            {distractionBlocker.enabled ? (
                  ...
                  {['light', 'medium', 'strong'].map(level => (
                    <label key={level} style={{ 
                      ...
                      <span style={{ textTransform: 'capitalize' }}>{level} ({
                        level === 'light' ? 'Subtle blur' :
                        level === 'medium' ? 'Strong blur' :
                        'Full overlay'
                      })</span>
                    </label>
                  ))}
              ...
              <div>
                <p style={{ fontSize: 13, color: "#666", marginBottom: 12 }}>
                  Creates a visual barrier when you try to leave the app during focus sessions. Soft-lock method: easily disabled but creates helpful friction.
                </p>
                <div style={{ fontSize: 12, color: "#777", marginBottom: 12 }}>
                  <div>🔒 Activates when you switch tabs/apps</div>
                  <div>👁️ Blurs or overlays the screen</div>
                  <div>🛡️ Gentle reminder to stay focused</div>
                  <div>🔓 Easy to disable when needed</div>
                </div>
                <button 
                  style={{...currentStyles.btn, width: '100%' }} 
      ...
      case 'supportCreator':
        return (
          <div key="supportCreator" style={{
            ...currentStyles.card,
            background: `linear-gradient(135deg, ${currentTheme.cardBg} 0%, ${currentTheme.background} 100%)`,
            border: `2px solid ${currentTheme.border}`,
            borderRadius: 16,
            boxShadow: `0 8px 32px ${currentTheme.shadow}20, 4px 4px 0px ${currentTheme.border}`,
            overflow: 'hidden',
            position: 'relative'
          }}>
            ...
            <div style={{
              ...
              <div style={{ 
                ...
                Help fuel innovation & new features
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 8, color: currentTheme.text }}>
                🎯 Building the Future of Productivity
              </div>
              <div style={{ fontSize: 13, color: currentTheme.textSecondary, lineHeight: 1.4 }}>
                Your support helps me create better AI-powered productivity tools and educational content for everyone.
              </div>
            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                      <div style={{ fontWeight: 600, fontSize: 14 }}>YouTube Channel</div>
                      <div style={{ fontSize: 11, opacity: 0.9 }}>Ctrl+Alt+Study • Productivity Tips</div>
                    </div>
                  </div>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <span style={{ fontSize: 20 }}>📱</span>
                    <div>
                      <div style={{ fontWeight: 600, fontSize: 14 }}>TikTok</div>
                      <div style={{ fontSize: 11, opacity: 0.9 }}>@focusguard101 • Quick Tips</div>
                    </div>
                  </div>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <div style={{
                  ...
                  Every coffee helps me dedicate more time to building amazing productivity tools!
                </div>
              </div>
              ...
              <div
                ...
                onClick={() => {
                  ...
                  playButtonClickSound();
                  alert('📱 GCash Number Copied!\n\n09613777353\n\n✨ Thank you for supporting FocusGuard!\nYour contribution helps me build better productivity tools! 💙');
                }}
                onMouseOver={(e) => {
                  e.target.style.transform = 'translateY(-2px)';
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 15 }}>GCash Payment</div>
                    <div style={{ fontSize: 12, opacity: 0.9 }}>09613777353 • Click to copy</div>
                  </div>
                </div>
                <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 16, fontWeight: 700, color: currentTheme.text }}>70+</div>
                  <div style={{ fontSize: 9, color: currentTheme.textSecondary }}>Features</div>
                </div>
                <div style={{
                  textAlign: 'center',
                  padding: '8px 4px',
                  ...
                  <div style={{ fontSize: 16, fontWeight: 700, color: currentTheme.text }}>3,500+</div>
                  <div style={{ fontSize: 9, color: currentTheme.textSecondary }}>Lines of Code</div>
                </div>
                <div style={{
                  textAlign: 'center',
                  padding: '8px 4px',
                  ...
                  <div style={{ fontSize: 16, fontWeight: 700, color: currentTheme.text }}>100%</div>
                  <div style={{ fontSize: 9, color: currentTheme.textSecondary }}>Free & Open</div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 12, color: currentTheme.textSecondary, fontStyle: 'italic' }}>
                  💙 Every contribution, big or small, makes a difference.<br/>
                  Thank you for being part of the FocusGuard community!
                </div>
              </div>
            </div>
          </div>
